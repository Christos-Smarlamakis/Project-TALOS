...
title Project TALOS v5.10.14 -- Research Intelligence Dashboard
...
echo %C_IEEE_LIGHT%             ██    ██   ██ ███████  ██████  ██████  %C_RESET%
echo %C_IEEE_DARK%=====================================================================================================%C_RESET%
echo  %C_CYAN%Project TALOS v5.10.14 -- Research Intelligence Ecosystem (IEEE WEIGD Supported)%C_RESET%
echo %C_IEEE_DARK%=====================================================================================================%C_RESET%
...
call :LOG_SUCCESS "TALOS v5.10.14 deployment finalized."
pause
goto MAIN_MENU
