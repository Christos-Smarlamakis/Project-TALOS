...
title Project TALOS v5.9.17 -- Research Intelligence Dashboard
...
REM version        : v5.9.17 (Sealed Architecture)
...
echo %C_IEEE_LIGHT%             ██    ██   ██ ███████  ██████  ██████  %C_RESET%
echo %C_IEEE_DARK%=====================================================================================================%C_RESET%
echo  %C_CYAN%Project TALOS v5.9.17 -- Research Intelligence Ecosystem (IEEE WEIGD Supported)%C_RESET%
echo %C_IEEE_DARK%=====================================================================================================%C_RESET%
...
call :LOG_SUCCESS "TALOS v5.9.17 deployment finalized."
pause
goto MAIN_MENU
