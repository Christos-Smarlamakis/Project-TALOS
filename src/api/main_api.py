...
description="Facade REST API for the TALOS autonomous research platform (v5.10.6 -- Daemon OS Autostart & Orchestrator)",
version="5.10.6",
)
app.add_middleware(
    CORSMiddleware,
...
def on_startup():
    ...
    logger.info("TALOS FastAPI v5.10.6 starting up (Daemon OS Autostart & Orchestrator, port 8001)...")
