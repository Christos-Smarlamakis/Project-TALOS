...
description="Facade REST API for the TALOS autonomous research platform (v5.9.14 -- Documentation & Version Sync)",
version="5.9.14",
)
app.add_middleware(
    CORSMiddleware,
...
def on_startup():
    ...
    logger.info("TALOS FastAPI v5.9.14 starting up (Documentation & Version Sync, port 8001)...")
