...
app = FastAPI(
    ...
    description="Facade REST API for the TALOS autonomous research platform (v5.8.3 -- Multi-Tier LLM Routing, Auto-Conda Detection, Background Window Spawning, Synapse protocol active, React frontend)",
    version="5.8.3",
)
app.add_middleware(
    CORSMiddleware,
...
def on_startup():
    ...
    logger.info("TALOS FastAPI v5.8.3 starting up (Multi-Tier LLM, Auto-Conda Detection, Background Window Spawning, Synapse protocol active, port 8001)...")
