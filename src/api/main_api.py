...
app = FastAPI(
    ...
    description="Facade REST API for the TALOS autonomous research platform (v5.8.2 -- Multi-Tier LLM Routing, Synapse protocol active, React frontend)",
    version="5.8.2",
)
app.add_middleware(
    CORSMiddleware,
...
def on_startup():
    ...
    logger.info("TALOS FastAPI v5.8.2 starting up (Multi-Tier LLM, Synapse protocol active, port 8001)...")
