...
description="Facade REST API for the TALOS autonomous research platform (v5.8.8 -- Resilient Ingestion, Graceful Import Degradation, Synapse protocol active, React frontend)",
version="5.8.8",
)
app.add_middleware(
    CORSMiddleware,
...
def on_startup():
    ...
    logger.info("TALOS FastAPI v5.8.8 starting up (Resilient Ingestion, Graceful Import Degradation, Synapse protocol active, port 8001)...")
