...
app = FastAPI(
    ...
    description="Facade REST API for the TALOS autonomous research platform (v5.7.2 -- Synapse protocol active, React frontend)",
    version="5.7.2",
)
app.add_middleware(
    CORSMiddleware,
...
def on_startup():
    ...
    logger.info("TALOS FastAPI v5.7.2 starting up (Synapse protocol active, port 8001)...")
