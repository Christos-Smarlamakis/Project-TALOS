...
description="Facade REST API for the TALOS autonomous research platform (v5.9.13 -- Academic Print Theme Injection for AST Graphs)",
version="5.9.13",
)
app.add_middleware(
    CORSMiddleware,
...
def on_startup():
    ...
    logger.info("TALOS FastAPI v5.9.13 starting up (Academic Print Theme Injection for AST Graphs, port 8001)...")
